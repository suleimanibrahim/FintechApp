...
const BankTransfer = () => {
  ...
  let [allBanks, setAllBanks] = useState<any>([]);
  ...
  let accountNumberRef = useRef<any>(0);
  let amountRef = useRef<any>(0);
  let pinRef = useRef<any>(0);
  let narrationRef = useRef<any>(0);
  let receiverNameRef = useRef<any>(0);
  ...
  const resolveReceiver = async (e: any) => {
  ...
  return (
    <>
      ...
      <div className="other--transfer-links">
        <p>
          {" "}
          <Link to="/local-transfer" className="local">
            Local Transfer
          </Link>
        </p>
        <p>
        ...
        <div className="other--transfer-formContainer">
          <form onSubmit={handleSubmit}>
            ...
            <input
              ...
              className="other--transfer-input"
            ...
            <label className="other-label" hidden={isHidden}>
              Account Name
            </label>{" "}
            <br />
            <input
      ...
      <div id={successButton}>
        ...
        <button onClick={transferSuccess} id="transfer-success-button">
          Ok
        </button>
      </div>
...
const Modal = (props: any) => {
  return (
    <>
      <div id={props.modal}>
        <p>{props.message}</p>
        <button id="close" onClick={props.handleModal}>
          {" "}
          Close{" "}
        </button>
      </div>
